...
// Widen FlowEmits: inferring event names from its overloads trips TS2589.
const forwarded = useForwardPropsEmits(props, emits as (name: string, ...args: unknown[]) => void)
</script>
