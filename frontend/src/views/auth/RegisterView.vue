...
import { EyeIcon, EyeOffIcon, Loader2Icon, UserPlusIcon } from '@lucide/vue'
...
async function handleSubmit() {
  ...
  if (res.error.fieldErrors) {
    ...
    errors.email = res.error.fieldErrors.primary_email?.[0] ?? res.error.fieldErrors.email?.[0]
      ...
      <CardContent class="space-y-4">
        ...
        <div class="space-y-1.5">
          ...
          <Input
            ...
            :disabled="submitting"
          />
          <p v-if="errors.display_name" class="text-xs text-destructive">
            {{ errors.display_name }}
          </p>
        </div>
