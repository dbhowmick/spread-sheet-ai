defmodule SpreadSheetAi.Conversations do
  ...
  Every public function takes a `SpreadSheetAi.Accounts.Scope` as its first argument.
  ...
  alias SpreadSheetAi.Accounts.Scope, as: Scope
