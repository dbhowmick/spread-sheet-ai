defmodule SpreadSheetAi.Agents.FactoryConfig do
  @moduledoc """
  Typed configuration consumed by `SpreadSheetAi.Agents.Factory.create_agent/2`.
  ...
  From a Phoenix LiveView socket's assigns:
      ...
      SpreadSheetAi.Agents.FactoryConfig.from_socket_assigns(socket.assigns)
      |> SpreadSheetAi.Agents.FactoryConfig.build()

  From a neutral map (GenServer, GraphQL resolver, test):

      SpreadSheetAi.Agents.FactoryConfig.from_inputs(%{
        scope: scope,
  ...
  call site can compose them:
      ...
      SpreadSheetAi.Agents.FactoryConfig.from_inputs(inputs)
      |> SpreadSheetAi.Agents.FactoryConfig.with_project(project)
      |> SpreadSheetAi.Agents.FactoryConfig.build()
  """
