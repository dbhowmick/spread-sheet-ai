defmodule SpreadSheetAi.Agents.FactoryRouter do
  @moduledoc """
  ...
  generated `resolve/3` builds a `%SpreadSheetAi.Agents.FactoryConfig{}` from
  the router's inputs and pairs it with `SpreadSheetAi.Agents.Factory`.
  ...
  route among multiple factories. A common multi-factory pattern is:
      ...
      defmodule SpreadSheetAi.Agents.FactoryRouter do
        ...
        alias SpreadSheetAi.Agents.{CodingFactory, CodingConfig}
        alias SpreadSheetAi.Agents.{WritingFactory, WritingConfig}
        alias SpreadSheetAi.Agents.{DefaultFactory, DefaultConfig}

        @impl true
        def resolve(scope, conversation_id, request_opts) do
          conversation =
            SpreadSheetAi.Conversations.get_conversation!(scope, conversation_id)
  ...
  use Sagents.Routers.Single,
    factory: SpreadSheetAi.Agents.Factory,
    config: SpreadSheetAi.Agents.FactoryConfig
end
